      ...
      <Box width={"100%"}>
         <Box border={"3px solid #6504b5"}>
            ...
            <Input
               ...
               placeholder="Search Cat, Dogs etc."
            ></Input>
            <br />
            <Input
               h={50}
               placeholder="Nearby Municipality"
            ...
            <Heading
               ...
               //  borderRadius="20px"
            >
               Find your new best friend Browse pets from our network of more
               than 1,000 shelters and rescues.
            </Heading>
            <Box 
            padding={"18% 17%"} 
