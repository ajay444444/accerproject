 ...
 let {adminLogin,adminLoginFunc} = useContext(adminContext)
  ...
  return (
    <Box display={"flex"} justifyContent={"center"}>
      <Flex w="60%" mb="40px" mt="80px" justifyContent={"center"} gap="20px" boxShadow={"rgba(0, 0, 0, 0.6) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset"} padding={"20px"}>
        ...
        <i style={{position: "absolute", top: "53%", right: "52%"}} onClick={togglePasswordVisiblity}>{eye}</i>
        <br />
